...
export interface CompanyProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "factory"
...
export interface CompanyProxy extends BaseContract {
  connect(runner?: ContractRunner | null): CompanyProxy;
  waitForDeployment(): Promise<this>;

  interface: CompanyProxyInterface;
