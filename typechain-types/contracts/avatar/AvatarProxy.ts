...
export interface AvatarProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "factory"
...
export interface AvatarProxy extends BaseContract {
  connect(runner?: ContractRunner | null): AvatarProxy;
  waitForDeployment(): Promise<this>;

  interface: AvatarProxyInterface;
