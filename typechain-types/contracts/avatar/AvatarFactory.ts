...
export interface AvatarFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface AvatarFactory extends BaseContract {
  connect(runner?: ContractRunner | null): AvatarFactory;
