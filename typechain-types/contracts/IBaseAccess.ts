...
export interface IBaseAccessInterface extends Interface {
  getFunction(
...
export interface IBaseAccess extends BaseContract {
  connect(runner?: ContractRunner | null): IBaseAccess;
  waitForDeployment(): Promise<this>;

  interface: IBaseAccessInterface;
