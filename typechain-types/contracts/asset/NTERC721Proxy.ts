...
export interface NTERC721ProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "factory"
...
export interface NTERC721Proxy extends BaseContract {
  connect(runner?: ContractRunner | null): NTERC721Proxy;
  waitForDeployment(): Promise<this>;

  interface: NTERC721ProxyInterface;
