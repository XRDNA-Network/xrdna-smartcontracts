...
export interface NonTransferableERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "assetFactory"
...
export interface NonTransferableERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): NonTransferableERC721;
