...
export interface ERC20AssetRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export namespace ERC20AssetCreatedEvent {
...
export interface ERC20AssetRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20AssetRegistry;
  waitForDeployment(): Promise<this>;

  interface: ERC20AssetRegistryInterface;
  ...
  getEvent(
    key: "ERC20AssetCreated"
  ): TypedContractEvent<
    ERC20AssetCreatedEvent.InputTuple,
    ERC20AssetCreatedEvent.OutputTuple,
    ERC20AssetCreatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "ERC20AssetCreated(address,address,address,uint256)": TypedContractEvent<
      ERC20AssetCreatedEvent.InputTuple,
      ERC20AssetCreatedEvent.OutputTuple,
      ERC20AssetCreatedEvent.OutputObject
    >;
    ERC20AssetCreated: TypedContractEvent<
      ERC20AssetCreatedEvent.InputTuple,
      ERC20AssetCreatedEvent.OutputTuple,
      ERC20AssetCreatedEvent.OutputObject
    >;
