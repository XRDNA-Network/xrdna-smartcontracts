...
export interface ERC721AssetFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ERC721AssetFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721AssetFactory;
  waitForDeployment(): Promise<this>;

  interface: ERC721AssetFactoryInterface;
