...
export interface IWorldRegistry0_1Interface extends Interface {
  getFunction(
...
export interface IWorldRegistry0_1 extends BaseContract {
  connect(runner?: ContractRunner | null): IWorldRegistry0_1;
  waitForDeployment(): Promise<this>;

  interface: IWorldRegistry0_1Interface;
