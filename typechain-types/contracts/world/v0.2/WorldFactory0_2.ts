...
export interface WorldFactory0_2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface WorldFactory0_2 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldFactory0_2;
  waitForDeployment(): Promise<this>;

  interface: WorldFactory0_2Interface;
