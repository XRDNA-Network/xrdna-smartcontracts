...
export interface IWorldRegistry0_2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IWorldRegistry0_2 extends BaseContract {
  connect(runner?: ContractRunner | null): IWorldRegistry0_2;
  waitForDeployment(): Promise<this>;

  interface: IWorldRegistry0_2Interface;
