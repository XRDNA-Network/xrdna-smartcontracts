...
export interface WorldRegistryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface WorldRegistryV2 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldRegistryV2;
  waitForDeployment(): Promise<this>;

  interface: WorldRegistryV2Interface;
