...
export interface WorldV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "avatarRegistry"
...
export interface WorldV2 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldV2;
  waitForDeployment(): Promise<this>;

  interface: WorldV2Interface;
