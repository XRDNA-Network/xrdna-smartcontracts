...
export interface WorldProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "factory"
...
export interface WorldProxy extends BaseContract {
  connect(runner?: ContractRunner | null): WorldProxy;
  waitForDeployment(): Promise<this>;

  interface: WorldProxyInterface;
