...
export interface IWorldV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "getBaseVector"
...
export interface IWorldV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IWorldV2;
  waitForDeployment(): Promise<this>;

  interface: IWorldV2Interface;
