...
export interface IWorld0_2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "getBaseVector"
...
export interface IWorld0_2 extends BaseContract {
  connect(runner?: ContractRunner | null): IWorld0_2;
  waitForDeployment(): Promise<this>;

  interface: IWorld0_2Interface;
