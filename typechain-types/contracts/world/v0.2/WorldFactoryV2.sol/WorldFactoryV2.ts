...
export interface WorldFactoryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface WorldFactoryV2 extends BaseContract {
  connect(runner?: ContractRunner | null): WorldFactoryV2;
  waitForDeployment(): Promise<this>;

  interface: WorldFactoryV2Interface;
