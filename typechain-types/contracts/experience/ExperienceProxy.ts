...
export interface ExperienceProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSigners"
      | "factory"
...
export interface ExperienceProxy extends BaseContract {
  connect(runner?: ContractRunner | null): ExperienceProxy;
  waitForDeployment(): Promise<this>;

  interface: ExperienceProxyInterface;
