...
library LibExtensions {
    ...
    function _doCall(address target, bytes memory data) private returns (bytes memory) {
        ...
        /*******
         Can't seem to get to bubble up revert message from downstream delegate. So doing outside of assembly
        ...
        assembly {
            ...
            calldatacopy(freePtr, dataPtr, dataLength)
            ...
            success := delegatecall(
                ...
                dataLength,      // Length of the input data
