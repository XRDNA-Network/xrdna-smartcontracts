...
export default buildModule("CompanyExtResolverModule", (m) => {
        ...
        const owner = config.companyExtResolverAdmin;
        const others = config.companyExtResolverOtherAdmins;
        ...
        const re = m.contract("CompanyExtResolver", [args], {
            libraries: {
