...
import ExperienceRegstryModule from "../experience/registry/ExperienceRegistry.module";
...
export default buildModule("PortalRegistryModule", (m) => {
        ...
        const expReg = m.useModule(ExperienceRegstryModule).experienceRegistry;
        const avReg = m.useModule(AvatarRegistryModule).avatarRegistry;
