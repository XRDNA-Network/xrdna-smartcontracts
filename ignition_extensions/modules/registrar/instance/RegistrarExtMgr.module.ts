...
import {abi as bABI} from '../../../../artifacts/contracts/entity/extensions/basic-entity/interfaces/IBasicEntityExt.sol/IBasicEntityExt.json';
import {abi as fABI} from '../../../../artifacts/contracts/core/extensions/funding/interfaces/IFundsExtension.sol/IFundsExtension.json';
...
import {abi as erABI} from '../../../../artifacts/contracts/entity/extensions/removable/interfaces/IRemovableExtension.sol/IRemovableExtension.json';
...
export default buildModule("RegistrarExtMgrModule", (m) => {
    ...
    const extMgr = m.contract("RegistrarExtMgr", [args], {
        libraries: {
    ...
    generateABI({
        contractName: "RegistrarExtMgr",
        abi: abi
    })
    return {
        registrarExtensionManager: extMgr
    };
});