...
export default buildModule("RegistrarExtResolverModule", (m) => {
        ...
        const owner = config.registrarExtResolverAdmin;
        const others = config.registrarExtResolverOtherAdmins;
        ...
        const re = m.contract("RegistrarExtResolver", [args], {
            libraries: {
