...
export default buildModule("AvatarExtResolverModule", (m) => {
        ...
        const owner = config.avatarExtResolverAdmin;
        const others = config.avatarExtResolverOtherAdmins;
        ...
        const re = m.contract("AvatarExtResolver", [args], {
            libraries: {
