...
import {TermedRegistration, RegistrationStorage, LibRegistration} from './LibRegistration.sol';
...
library LibControlChange {
    ...
    function _verifyMigrationSigs(ChangeControllerArgs calldata args) internal view {
        ...
        require(IAccessControl(args.entity).isSigner(w), "Registrar: entity signature invalid");
    }
}