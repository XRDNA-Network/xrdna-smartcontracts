...
contract NTERC721ExtResolver is BaseExtResolver {
    ...
    constructor(BaseExtResolverConstructorArgs memory args) BaseExtResolver(args) {
        ...
        extNames[2] = LibExtensionNames.ERC721_INFO;
        extNames[3] = LibExtensionNames.ERC721_MINTING;
        extNames[4] = LibExtensionNames.ERC721_TRANSFER;        
